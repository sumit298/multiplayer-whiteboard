export const Errors = {
    ...
    MAX_VIEWER_LIMIT_REACHED_ON_ORGANIZATION: {
      code: 4027,
      message:
        "You have reached max viewer limit on organization. To increase contact at support@videosdk.live",
    },
    ...
    RECORDING_DURATION_LIMIT_REACHED: {
      code: 5004,
      generateMessage: ({ maxHoursLimit }: { maxHoursLimit: number }) => {
    ...
    LIVESTREAM_DURATION_LIMIT_REACHED: {
      code: 5005,
      generateMessage: ({ maxHoursLimit }: any) => {
